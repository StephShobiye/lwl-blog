---
layout: post
title: "Audit Wales says the ALN system is under strain. Families in Wales will not be surprised."
description: "A response to the April 2026 Audit Wales ALN report, looking at the main pinch points in the system, why families are feeling the strain, and how earlier co-ordination through a Prevent, Bridge, Progress approach could reduce escalation."
date: 2026-04-08
author: "Learn Without Limits CIC"
categories: [ALN, Wales, Policy, Parent Support]
tags: [ALN, Additional Learning Needs, Wales, Audit Wales, IDP, Tribunal, EHE, SEND, policy, parent support]
...
This is also a theme we have already explored in earlier LWL pieces, including [Why ALN support often arrives after crisis](https://blog.learnwithoutlimitscic.org/2026/03/13/why-aln-support-arrives-after-crisis/) and [When children cannot attend school in Wales](https://blog.learnwithoutlimitscic.org/2026/03/13/when-children-cannot-attend-school-wales/).
...
We summarised that clarification here: [ALN decision-making timescales in Wales](https://blog.learnwithoutlimitscic.org/2026/03/aln-decision-making-timescales-wales.html).

For readers who want the underlying official guidance, Welsh Government’s operational page is here: [Additional learning needs (ALN): decision making and communication](https://www.gov.wales/additional-learning-needs-aln-decision-making-and-communication-html).
...
We set out that model in more detail here: [Prevention, Bridging, Progression in the ALN System](https://blog.learnwithoutlimitscic.org/2026/03/18/prevention-bridging-progression-aln/).
...
That thinking also sits alongside our earlier pieces on [From Facebook community to knowledge infrastructure](https://blog.learnwithoutlimitscic.org/2026/03/13/from-facebook-community-to-knowledge-infrastructure/) and [When communities design the solution](https://blog.learnwithoutlimitscic.org/2026/03/13/when-communities-design-the-solution/).
