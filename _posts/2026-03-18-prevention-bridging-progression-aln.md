---
layout: post
title: "Prevention, Bridging and Progression in the ALN System"
date: 2026-03-18
categories: [ALN, Systems Change, Early Intervention]
tags: [ALN, Wales, SEND, EOTAS, Early Intervention, Parent Carers]
...
## 🌱 From lived experience to system insight
...
## ⚠️ Where the system breaks down

![Diagram showing where learners fall out of the education system and increasing risk of disengagement across key stages](/assets/images/aln-escalation-risk-model.jpg)
...
This is not about adding complexity to the system.
It is about making what already exists easier to navigate, earlier.

---

## 🧭 The Prevent → Bridge → Progress model

![Diagram showing escalation pathway without support compared to prevention through early guidance and knowledge](/assets/images/prevention-impact-model.jpg)
...
![Diagram showing bridging pathways for young people and parent carers leading to re-engagement and progression](/assets/images/bridging-progression-pathways.jpg)
...
**community insight → practical tools → system learning**

---

## 🤝 Cross-sector convening in practice
...
- [When Children Cannot Attend School in Wales](https://blog.learnwithoutlimitscic.org/2026/03/13/when-children-cannot-attend-school-wales/)
- [Why Support for Children with ALN Often Arrives Only After Crisis](https://blog.learnwithoutlimitscic.org/2026/03/13/why-aln-support-arrives-after-crisis/)
- [When Communities Build Their Own Infrastructure](https://blog.learnwithoutlimitscic.org/2026/03/13/when-communities-build-their-own-infrastructure/)
- [From Facebook Community to Knowledge Infrastructure](https://blog.learnwithoutlimitscic.org/2026/03/13/from-facebook-community-to-knowledge-infrastructure/)
- [When Communities Design the Solution](https://blog.learnwithoutlimitscic.org/2026/03/13/when-communities-design-the-solution/)
